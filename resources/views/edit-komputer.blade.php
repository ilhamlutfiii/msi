...
<div class="card-body card-block">
	...
	<form action="/komputer/update" method="post" class="">
		...
		<div class="form-group"><label class="form-control-label">Inventaris :</label><input type="text" name="inventaris" class="form-control" value="{{ $k->inventaris }}"></div>
		...
		<div class="form-group"><label class="form-control-label">Keterangan :</label><textarea name="keterangan" class="form-control">{{ $k->keterangan }}</textarea></div>
		...
		<input type="hidden" name="komp_id" class="form-control" value="{{ $k->komp_id }}">
	</form>
	@endforeach
</div>
