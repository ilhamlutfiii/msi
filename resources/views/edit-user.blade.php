...
<div class="card-body card-block">
	...
	<form action="/user/update" method="post" class="">
		...
		<div class="form-group"><label class="form-control-label">Konfirmasi Password :</label><input type="text" name="cpass" class="form-control" value="{{ $u->cpass }}"></div>
		...
		<input type="hidden" name="user_id" class="form-control" value="{{ $u->user_id }}" readonly>
	</form>
	@endforeach
</div>
